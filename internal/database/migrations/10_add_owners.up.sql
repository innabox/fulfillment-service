...
alter table virtual_machine_templates add column owners text[] not null default '{}';
alter table virtual_machines add column owners text[] not null default '{}';
...
create index virtual_machine_templates_by_owner on virtual_machine_templates using gin (owners);
create index virtual_machines_by_owner on virtual_machines using gin (owners);
...
alter table archived_virtual_machine_templates add column owners text[] not null default '{}';
alter table archived_virtual_machines add column owners text[] not null default '{}';
