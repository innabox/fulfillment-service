...
// ComputeInstanceUuid is the label where the fulfillment API will write the identifier of the virtual machine.
var ComputeInstanceUuid = fmt.Sprintf("%s/%s", gvks.ComputeInstance.Group, "virtualmachine-uuid")
